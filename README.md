# pokemons_generation
This repo contains GAN for pokemon generating. Below, results of the network after 20000 iterations.
...
To train network or check it with pretrained weights run corresponding cells in main.ipynb. 
